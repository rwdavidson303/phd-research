...
description: "Vendor journey: United Kingdom procurement and US market entry"
weight: 3
---
...
2. **"Most Advantageous Tender" replaces MEAT.** The Procurement Act 2023 explicitly adopts "Most Advantageous Tender" as the award criterion, signaling a policy preference for holistic evaluation over lowest price. The National Procurement Policy Statement reinforces this by emphasizing "long-term public value."

3. **Lower barriers, broader competition.** With cumulative pre-revenue costs roughly one-tenth of the US equivalent, the UK system allows more firms to participate. The 75% SME supplier rate on CCS frameworks suggests the lower barriers translate to broader competition in practice.

4. **The framework model reduces repeat costs.** CCS frameworks (800+ agreements) allow pre-qualified suppliers to compete for call-offs without repeating full qualification — effectively amortizing sunk costs across multiple opportunities. The US IDIQ/BPA model is analogous but typically requires more expensive initial qualification.
...
- Loader, K. (2015). SME suppliers and the challenge of public procurement. *Journal of Purchasing and Supply Management*, 21(2), 95–104.
- Sanchez-Graells, A. (2019). *Public Procurement and the EU Competition Rules* (2nd ed.). Hart Publishing.
