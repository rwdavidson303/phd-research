...
1. Contracting authority publishes a call describing needs in functional/performance terms
2. Partners are selected based on capacity for research and innovation
3. Partners develop solutions through progressive R&D phases with competitive down-selection
4. Upon successful completion, the authority can purchase the solution without a new procurement
...
1. **The MEAT standard demonstrates that quality-focused evaluation can be established as a norm across 27 diverse countries** — the US could certainly mandate it across federal agencies.
2. **Life-cycle costing methodology provides a rigorous, defensible framework** for looking beyond initial price — precisely the tool US contracting officers need when justifying best-value awards against protest challenge.
3. **Lithuania's sustainable procurement transformation** shows that ambitious targets can be achieved rapidly with the right combination of mandates, guidance, and capacity building.
4. **The innovation partnership procedure** provides a template for a US FAR innovation pathway.
